...
export default async function Shop(){
  try{
    ...
    return <main><SiteHeader/><section className="route-state shell"><p className="eyebrow">The collection</p><h1>We’re refreshing the collection.</h1><p>Please try again in a moment.</p><Link className="button" href="/shop">Try again</Link></section><SiteFooter/></main>;
  }
}
